...
BUFFER_SIZE = 1500  # Tamanho do buffer para recepção dos dados
...
def receber_pacotes(s, caminho_arquivo):
    ...
    with open(caminho_arquivo, "wb") as f:
        ...
        while recebidos < tamanho_arquivo:
            ...
            # Retira o número de sequência do pacote
            ...
            if int(num_seq) == num_seq_aux:
                ...
                f.write(dados)
                recebidos += len(dados)
                # Envia a confirmação de recebimento com o número de sequência correto
                num_seq_aux += 1
                s.sendto(num_seq, addr)
            else:
                # Envia a confirmação de recebimento do último pacote recebido
